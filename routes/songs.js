  ...
  try {
    ...
    const myQuery =
      `SELECT 
        ...
        OR u.first_name + ' ' + u.last_name LIKE @keyword -- Search by artist's full name (first + last)`; // Search for songs with the keyword, joining related tables to get artist, album, and genre names
